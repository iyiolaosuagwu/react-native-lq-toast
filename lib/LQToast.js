...
const LQToast = ({ title, description, variant = "default", isVisible, direction = "top", duration, offsetTop = 60, offsetBottom = 100, onDismiss, customComponent: CustomComponent, }) => {
