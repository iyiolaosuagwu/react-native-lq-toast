...
export const ToastProvider = ({ children, direction = "top", customComponent, duration = 4000, offsetTop = 30, offsetBottom = 30, keyboardOffset = 0, }) => {
    ...
    return (<ToastContext.Provider value={{ showToast, hideToast }}>
            {children}
            <LQToast {...toast} onDismiss={hideToast} direction={direction} customComponent={customComponent} offsetTop={offsetTop} offsetBottom={offsetBottom} keyboardOffset={keyboardOffset}/>
