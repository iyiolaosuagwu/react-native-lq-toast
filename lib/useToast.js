...
export const ToastProvider = ({ children, direction = "top", customComponent, duration = 300, }) => {
    ...
    return (<ToastContext.Provider value={{ showToast, hideToast }}>
            {children}
            <LQToast {...toast} onDismiss={hideToast} direction={direction} customComponent={customComponent} duration={duration}/>
