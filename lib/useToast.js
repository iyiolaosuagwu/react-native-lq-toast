...
export const ToastProvider = ({ children, position = "top", animationType = "slide", customToastComponent, duration = 4000, offsetTop = 30, offsetBottom = 30, }) => {
    ...
    return (<ToastContext.Provider value={{ showToast, hideToast }}>
            {children}
            <LQToast {...toast} onDismiss={hideToast} position={position} animationType={animationType} customToastComponent={customToastComponent} offsetTop={offsetTop} offsetBottom={offsetBottom}/>
